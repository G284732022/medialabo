...
let ps = document.querySelectorAll('dl');
for(let p of ps){
  console.log(p.textContent);
}


let btn = document.querySelector('#kensaku');
btn.addEventListener('click',kensaku)
let kaisu =0;
function kensaku(){
  let grm = document.querySelector('select#syurui');
