...
l1.insertAdjacentElement('beforeend', img1);
let d = document.querySelector('div#phototable');
d.insertAdjacentElement('beforeend', l1);

let img2 = document.createElement('img');
img2.setAttribute('src', 'jiro.png');
let l2 = document.createElement('p'); 
l2.insertAdjacentElement('beforeend', img2);
d.insertAdjacentElement('beforeend', l2);

let img3 = document.createElement('img');
img3.setAttribute('src', 'hanako.png');
let l3 = document.createElement('p'); 
l3.insertAdjacentElement('beforeend', img3);
d.insertAdjacentElement('beforeend', l3);
